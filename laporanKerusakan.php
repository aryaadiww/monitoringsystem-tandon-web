        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Laporan Kerusakan Member</h4>
                    <div class="d-flex justify-content-end mb-3">
                      <div class="mr-4">
                        <input type="text" class="form-control text-white" id="searchInput" placeholder="Cari..." />
                      </div>
                      <div>
                       <button class="btn btn-primary" data-toggle="modal" data-target="#addArticleModal">Tambah Artikel</button>
                      </div>
                    </div>
                    <div class="table-responsive">
                      <table class="table table-hover text-center">
                        ...
                        <tbody>
                          ...
                          // Mengambil data dari tabel laporanKerusakan, alat, dan members
                          $sql = "SELECT 
                                      lr.id_laporan,
                                      lr.username, 
                                      lr.kode_alat, 
                                  ...
                                  FROM 
                                      laporanKerusakan lr
                                  JOIN 
                                      alat a ON lr.kode_alat = a.kode_alat
                                  JOIN 
                                      members m ON a.username_member = m.username";
          ...
          <div class="modal-body">
            <form method="post">
              <div class="form-group">
                ...
                <input type="date" class="form-control text-white" name="tanggal" id="tanggal" placeholder="Masukkan tanggal artikel" required>
              </div>
              <div class="form-group">
                <label for="articleTitle">Judul</label>
                <input type="text" class="form-control text-white" name="judul" id="judul" placeholder="Masukkan judul artikel" required>
              </div>
              <div class="form-group">
                <label for="articleDescription">Deskripsi</label>
                <textarea class="form-control text-white" name="deskripsi" id="deskripsi" rows="3" placeholder="Masukkan deskripsi artikel" required></textarea>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
            ...
            if (isset($_POST['submit'])) {
              ...
              $stmt = $conn->prepare("INSERT INTO artikel (tgl_upload, judul, deskripsi) VALUES (?, ?, ?)");
              ...
              if ($result) {
                  ...
                  echo '<script>alert("Artikel gagal disimpan: ' . $stmt->error . '");</script>';
              }
