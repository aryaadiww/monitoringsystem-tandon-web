...
// Ambil data alat user
$username = $_SESSION['username'];
$sql = mysqli_query($conn, "SELECT * FROM alat WHERE username_member = '$username'");
...
<html lang="en">
  <head>
    ...
    $(document).ready(function () {
        const ctx = document.getElementById('waterClarityChart').getContext('2d');
        ...
        function updateChart() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#turbidityValueDisplay').html(turbidityValue);
                    $('#statusAir').html(status);
                }
            });
        }
              ...
              <div class="col-md-10">
                ...
                <div class="card card-info">
                  <div class="card-header">
                    <h3 class="card-title text-center">Nilai Keruh Air</h3>
                  ...
                  <div class="card-body">
                    <div class="chart">
                    <canvas id="waterClarityChart"></canvas>
                    </div>
                    <!-- Menampilkan nilai kekeruhan air -->
                    <div class="text-center mt-3">
                      <h5>Nilai Kekeruhan Air: <span id="turbidityValueDisplay"><?php echo $turbidityValue; ?></span> nt<sup>U</sup></h5>
                    </div>
                  </div>
                  <!-- /.card-body -->
                </div>
