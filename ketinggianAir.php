...
<html lang="en">
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row justify-content-center">
              <div class="col-md-10">
                <!-- LINE CHART -->
                <div class="card card-tinggi">
                  <div class="card-tinggi-header">
                    <h3 class="card-title text-center">Ketinggian Air</h3>
                  </div>
                  <div class="card-tinggi-body">
                    <div class="water-level-container">
                      <div class="water-tank">
                        <div class="water" id="water"></div>
                      </div>
                      <div class="water-level-info">
                        <span id="ketinggian">Tunggu...</span>
                        <div class="status-info">Status: <span id="statusKetinggian">-</span></div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <!-- Menambahkan kode untuk chart bar dengan dua label -->
