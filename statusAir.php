      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav mt-4">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link <?php echo $current_page == 'statusAir.php' ? 'active' : ''; ?>" href="statusAir.php">
                <span class="menu-icon">
                <i class="mdi mdi-book-open"></i>
              </span>
              <span class="menu-title">Status Air</span>
            </a>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link <?php echo $current_page == 'tambahDevice.php' ? 'active' : ''; ?>" href="tambahDevice.php">
              ...
              <span class="menu-title">Tambah Device</span>
            </a>
          </li>
          <li class="nav-item menu-items">
    ...
    <div class="modal fade" id="addArticleModal" tabindex="-1" role="dialog" aria-labelledby="addArticleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <input type="date" class="form-control text-white" id="articleDate" placeholder="Masukkan tanggal artikel">
              </div>
              <div class="form-group">
                <label for="articleTitle">Judul</label>
                <input type="text" class="form-control text-white" id="articleTitle" placeholder="Masukkan judul artikel">
              </div>
              <div class="form-group">
                <label for="articleDescription">Deskripsi</label>
                <textarea class="form-control text-white" id="articleDescription" rows="3" placeholder="Masukkan deskripsi artikel"></textarea>
              </div>
              <div class="form-group">
                <label for="articleFile">File</label>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
            <button type="button" class="btn btn-primary">Simpan Artikel</button>
          </div>
        </div>
      </div>
    </div>
