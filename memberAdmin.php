...
// Cek dan tampilkan pesan notifikasi
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                      ...
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahMemberModal">
                        Tambah Member
                      </button>
                    </div>
                        ...
                        <tbody>
                          ...
                          if ($result->num_rows > 0) {
                              ...
                              while ($row = $result->fetch_array()) {
                                  ...
                                  echo "<td>{$row['bergabung']}</td>";
                                  echo "<td>
                                        <a href='hapusMember.php?username={$row['username']}' class='btn btn-danger' onclick=\"return confirm('Apakah Anda yakin ingin menghapus member ini?');\">Hapus</a>
                                      </td>";
                                  echo "</tr>";
                                  $no++;
                              }
    ...
    <div class="modal fade" id="tambahMemberModal" tabindex="-1" role="dialog" aria-labelledby="tambahMemberModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="prosesTambahMember.php"> <!-- Ganti dengan URL proses yang sesuai -->
              ...
              <div class="form-group">
                <label for="noHp" class="text-white">No. Telp</label>
                <input type="text" class="form-control text-white" id="noHp" name="noHp" required>
              </div>
              <div class="form-group">
